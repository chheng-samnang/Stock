...
class Supplyer extends CI_Controller
{
	...
	{
		parent::__construct();
		$this->pageHeader='Supplyer';
		$this->page_redirect="Supplyer";								
	...
	{		
		...
		$data["tbl_hdr"]=array("Suuplyer name","Email","Phone","Address","Status","Description","User create","Date create","User update","Date update");		
	...
	{		
		$this->form_validation->set_rules('txtSupplyerName','Supplyer Name','trim|required');
	...
	public function createCtrl($row="",$option="")
		{	
			...
			$ctrl = array(							
							array(
									'type'=>'text',
									'name'=>'txtSupplyerName',
									'id'=>'txtSupplyerName',									
									'value'=>$row==""? set_value("txtSupplyerName") : $row1,					
